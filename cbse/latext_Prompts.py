...
- Do not extract case study based questions or paragrapgh and all questions related to the case study and paragraph.
- Do not extract questions include or ends with "\\includegraphics" as these questions required images.
...
RULES for Rephrasing ,Removing and mapping:
    ...
    - Remove the incomplete questions whose concept is not complete or question in not completed.
    ...
    - Always change the numerical values and parameters in all questions to ensure they are solvable and meaningful.
